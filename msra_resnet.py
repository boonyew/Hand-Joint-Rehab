...
def generate_data_val(files,labels,batch_size,val=False):
...
def LSTMModel():
    model = Sequential()
    model.add(TimeDistributed(createResNetV1(),input_shape=(frames,cropHeight, cropWidth,1)))
    # model.add(LSTM(48,
...
model.fit_generator(
    ...
    epochs=15,
    validation_data=generate_data_val(val_files,val_labels,batch_size,val=True),
    validation_steps=85400//batch_size,
    steps_per_epoch=59000//batch_size,
    verbose=True,
